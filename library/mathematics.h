...
struct _basic_statistics // базова€ разреженна€ статистика с нул€ми
{
	std::vector<i64> data;
	i64 start = 0;
...
struct _interval_statistics // ограниченна€ интервальна€ статистика
{
	...
	void init_equiprobable(_basic_statistics &bs, i64 n, double k); // инициализировать равноверо€тным
	double min_mean(); // лева€ граница первого элемента
	double max_mean(); // права€ граница последнего элемента
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

struct _statistics // сжата€ статистика
{
	...
	i64 first_zero(); // номер первого нулевого элемента начина€ со start (-1 если не нашлось)
