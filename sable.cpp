...
bool _sable_stat::add1(const _prices2& c, _bit_stream& bs)
{
	...
	static const _cdf3 nnsegg[21] = { _cdf3() , // исправить
		...
		_cdf3(0, {4, 10, 22, 62, 46, 3}), // 5
		_cdf3(0, {5, 31, 27, 19, 55, 39, 2}), // 6
		_cdf3(0, {5, 31, 27, 55, 39, 51, 35, 2}), // 7
		_cdf3(0, {5, 31, 27, 39, 51, 35, 87, 119, 2}), // 8
		_cdf3(0, {5, 31, 19, 59, 43, 119, 71, 87, 103, 2}), // 9
		_cdf3(0, {15, 13, 19, 59, 57, 49, 107, 41, 33, 75, 2}), // 10
		_cdf3(0, {15, 13, 19, 59, 41, 49, 75, 33, 107, 121, 89, 2}), // 11
		_cdf3(0, {15, 9, 19, 59, 53, 37, 75, 107, 125, 109, 77, 93, 2}), // 12
		_cdf3(0, {15, 13, 19, 43, 49, 123, 121, 91, 89, 105, 65, 97, 73, 2}), // 13
		_cdf3(0, {15, 13, 19, 43, 41, 91, 89, 121, 113, 65, 251, 97, 187, 81, 2}), // 14
		_cdf3(0, {15, 13, 19, 59, 41, 107, 89, 113, 81, 65, 185, 203, 249, 139, 97, 2}), // 15
		_cdf3(0, {15, 13, 19, 59, 49, 107, 105, 73, 97, 139, 153, 217, 185, 249, 203, 65, 2}), // 16
		_cdf3(0, {5, 31, 27, 39, 119, 99, 215, 211, 147, 131, 279, 435, 307, 371, 499, 407, 195, 2}), // 17
		_cdf3(0, {5, 11, 63, 39, 119, 175, 215, 367, 399, 271, 1007, 751, 719, 591, 847, 975, 279, 407, 2}), // 18
		_cdf3(0, {5, 11, 63, 55, 79, 239, 199, 303, 423, 263, 943, 999, 871, 551, 615, 807, 743, 687, 391, 2}), // 19
...
//				research1.push(c.buy[n - 1].value - c.buy[n].value);
		...
		if (tip == 0)
		{
			i64 buy_izm2 = calc_delta_del_add1(c.buy, bbuy, n);
			bs.push1(buy_izm2 > 0);
			if (buy_izm2 < 0)
				bbuy.erase(bbuy.begin() + n);
			else
