...
_multi_interval ispe[36] = {
	_multi_interval(),
	_multi_interval({-99,-0.205, -0.125, -0.075, -0.045, -0.025, -0.005, 0.015, 0.035, 0.055, 0.085, 0.135, 0.215, 99}),
	_multi_interval({-99,-0.325, -0.195, -0.125, -0.075, -0.045, -0.015, 0.015, 0.055, 0.085, 0.135, 0.205, 0.335, 99}),
	_multi_interval({-99,-0.405, -0.245, -0.165, -0.105, -0.055, -0.015, 0.025, 0.065, 0.105, 0.165, 0.255, 0.415, 99}),
	_multi_interval({-99,-0.475, -0.285, -0.185, -0.125, -0.065, -0.015, 0.025, 0.075, 0.125, 0.195, 0.295, 0.475, 99}),
	_multi_interval({-99,-0.535, -0.325, -0.215, -0.135, -0.075, -0.015, 0.035, 0.085, 0.145, 0.215, 0.325, 0.535, 99}),
	_multi_interval({-99,-0.585, -0.355, -0.235, -0.155, -0.085, -0.025, 0.035, 0.085, 0.155, 0.235, 0.365, 0.595, 99}),
	_multi_interval({-99,-0.645, -0.385, -0.255, -0.165, -0.085, -0.025, 0.035, 0.095, 0.165, 0.255, 0.385, 0.635, 99}),
	_multi_interval({-99,-0.685, -0.415, -0.275, -0.175, -0.095, -0.025, 0.035, 0.105, 0.175, 0.275, 0.415, 0.685, 99}),
	_multi_interval({-99,-0.735, -0.435, -0.285, -0.185, -0.105, -0.035, 0.035, 0.105, 0.185, 0.295, 0.445, 0.745, 99}),
	_multi_interval({-99,-0.775, -0.455, -0.305, -0.195, -0.115, -0.035, 0.035, 0.115, 0.195, 0.305, 0.465, 0.785, 99}),
	_multi_interval({-99,-0.815, -0.485, -0.315, -0.205, -0.115, -0.035, 0.035, 0.125, 0.215, 0.325, 0.495, 0.825, 99}),
	_multi_interval({-99,-0.855, -0.505, -0.335, -0.215, -0.125, -0.045, 0.035, 0.125, 0.225, 0.335, 0.505, 0.845, 99}),
	_multi_interval({-99,-0.895, -0.535, -0.345, -0.225, -0.125, -0.045, 0.045, 0.135, 0.235, 0.355, 0.525, 0.885, 99}),
	_multi_interval({-99,-0.925, -0.555, -0.355, -0.235, -0.135, -0.045, 0.045, 0.145, 0.235, 0.365, 0.555, 0.925, 99}),
	_multi_interval({-99,-0.945, -0.575, -0.375, -0.245, -0.135, -0.045, 0.045, 0.145, 0.245, 0.385, 0.575, 0.955, 99}),
	_multi_interval({-99,-0.975, -0.595, -0.385, -0.255, -0.145, -0.045, 0.045, 0.145, 0.255, 0.395, 0.595, 0.985, 99}),
	_multi_interval({-99,-1.015, -0.605, -0.395, -0.265, -0.155, -0.045, 0.045, 0.145, 0.265, 0.405, 0.615, 1.025, 99}),
	_multi_interval({-99,-1.035, -0.625, -0.415, -0.265, -0.155, -0.045, 0.045, 0.155, 0.275, 0.415, 0.625, 1.065, 99}),
	_multi_interval({-99,-1.065, -0.645, -0.425, -0.275, -0.155, -0.055, 0.055, 0.165, 0.285, 0.425, 0.645, 1.085, 99}),
	_multi_interval({-99,-1.105, -0.655, -0.425, -0.275, -0.155, -0.055, 0.055, 0.165, 0.285, 0.435, 0.655, 1.115, 99}),
	_multi_interval({-99,-1.125, -0.675, -0.435, -0.285, -0.165, -0.055, 0.055, 0.165, 0.295, 0.445, 0.665, 1.135, 99}),
	_multi_interval({-99,-1.155, -0.675, -0.445, -0.285, -0.165, -0.055, 0.055, 0.165, 0.295, 0.455, 0.675, 1.175, 99}),
	_multi_interval({-99,-1.185, -0.695, -0.455, -0.285, -0.165, -0.055, 0.055, 0.175, 0.295, 0.455, 0.695, 1.185, 99}),
	_multi_interval({-99,-1.195, -0.715, -0.465, -0.295, -0.165, -0.055, 0.055, 0.175, 0.305, 0.465, 0.705, 1.215, 99}),
	_multi_interval({-99,-1.235, -0.725, -0.475, -0.295, -0.175, -0.055, 0.055, 0.175, 0.315, 0.475, 0.715, 1.235, 99}),
	_multi_interval({-99,-1.255, -0.745, -0.485, -0.305, -0.175, -0.055, 0.055, 0.175, 0.315, 0.475, 0.725, 1.255, 99}),
	_multi_interval({-99,-1.275, -0.765, -0.495, -0.305, -0.175, -0.055, 0.055, 0.175, 0.325, 0.485, 0.745, 1.265, 99}),
	_multi_interval({-99,-1.295, -0.775, -0.505, -0.315, -0.175, -0.055, 0.065, 0.185, 0.325, 0.495, 0.755, 1.275, 99}),
	_multi_interval({-99,-1.315, -0.795, -0.505, -0.315, -0.175, -0.055, 0.065, 0.185, 0.325, 0.495, 0.765, 1.305, 99}),
	_multi_interval({-99,-1.335, -0.805, -0.515, -0.325, -0.175, -0.055, 0.065, 0.195, 0.325, 0.505, 0.775, 1.325, 99}),
	_multi_interval({-99,-1.365, -0.825, -0.525, -0.325, -0.185, -0.055, 0.065, 0.195, 0.335, 0.515, 0.775, 1.355, 99}),
	_multi_interval({-99,-1.395, -0.825, -0.535, -0.335, -0.185, -0.055, 0.065, 0.195, 0.335, 0.515, 0.795, 1.355, 99}),
	_multi_interval({-99,-1.415, -0.835, -0.545, -0.335, -0.185, -0.055, 0.065, 0.195, 0.335, 0.535, 0.805, 1.365, 99}),
	_multi_interval({-99,-1.435, -0.855, -0.555, -0.345, -0.195, -0.055, 0.075, 0.195, 0.345, 0.535, 0.815, 1.375, 99}),
	_multi_interval({-99,-1.455, -0.865, -0.555, -0.355, -0.195, -0.055, 0.075, 0.205, 0.355, 0.545, 0.815, 1.405, 99})
};
